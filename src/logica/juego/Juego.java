...
*/	
	...
	private void hayColision(Entidad e1, Entidad e2) {
		...
		Rectangle r1 = new Rectangle(e1.getPosX()+2,e1.getPosY()+2,e1.getGrafica().getLabel().getWidth()-2,e1.getGrafica().getLabel().getHeight()-2);
		Rectangle r2 = new Rectangle(e2.getPosX()+2,e2.getPosY()+2,e2.getGrafica().getLabel().getWidth()-2,e2.getGrafica().getLabel().getHeight()-2);
		if (r1.intersects(r2)) {
